...
| [037](037-go-core-agent.md) | Go core agent | Match Python enrollment, coordinator HTTP, idle detection, and preemption behavior without adding a second wire protocol. |

> **Scope of this index.** ADRs **000 through 028** and **036 through 037** are accepted and present.
